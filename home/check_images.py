...
#     print("Argument 1:",in_arg.dir)
    ...
    #print('resultfor get pet labels',results)
    ...
    classify_images(in_arg.dir, results, in_arg.arch)
    #print("classify ooo images", results, in_arg.arch)
    ...
    adjust_results4_isadog(results, in_arg.dogfile)
    #print("is dog",adjust_results4_isadog(results, in_arg.dogfile))
