...
#     print(f"Percentage of Correct Dog Classifications: {results_stats_dic['pct_correct_dogs']}%")

    # Print percentage of correct "Not-a-Dog" classifications
    print(f"Percentage of Correct 'Not-a-Dog' Classifications: {results_stats_dic['pct_correct_notdogs']}%")

    # Print percentage of correct dog breed classifications
#     print(f"Percentage of Correct Dog Breed Classifications: {results_stats_dic['pct_correct_breed']}%")
